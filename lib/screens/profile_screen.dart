  ...
  @override Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        _tile(context, Icons.storefront, appState.isShopOwner ? 'لوحة المتجر: ${appState.shopName ?? ''}' : 'إنشاء حساب صاحب متجر', () async {
          if (appState.isAdmin) {
            try { await AdminStoreProvisioner.ensure(); } catch (e) { if (context.mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('تعذر تجهيز متجر الأدمن: $e'))); }
          }
