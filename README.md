...
### 4. التشغيل التجريبي (بالبيانات الوهمية، دون الحاجة إلى Supabase)
...
لأن أي APK حقيقي وموقّع يحتاج إلى بنائه من بيئة Android مهيأة، مع إعدادات Supabase وOAuth الخاصة بك. لا تضع مفاتيح سرية داخل المستودع أو تطبيق Flutter.
